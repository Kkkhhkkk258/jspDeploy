...
3. scopeAttr.jsp에서는 각영역에 속성을 설정
4. dispatcher를 이용하여 scopeResult.jsp화면 출력 기능을 위임
5. 브라우저의 화면 결과를 확인한다

시나리오2
1. 같은 브라우저의 신규 tab을 열어서 결과 화면으로 직접 이동한다
(scopeAttr.jspㄹ르 거치지 않는다)
localhost:8180/jsp/scope/scopeResult.jsp접속

시나리오3
1. 새로운 브라우저(인터넷 익스플로러)를 실행하여 결과 화면으로 직접 이동한다
localhost:8180/jsp/scope/scopeInput.jsp 
